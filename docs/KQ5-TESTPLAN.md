...
| ⛔ | M4 | castle halls | cat appears | ⛔ PLAY-FOUND SOFTLOCK + USER RULING 2026-08-19c: an unanswered encounter (incl. walking away) starts a 5-10 min fuse → Mordack materializes → death (remote screen = IN SCOPE). Ordering trap: fish-before-beast makes later encounters unanswerable. **RULED REMEDY (whale shape, NOT YET BUILT): the cat must not ARM until survivable — `(63 ∧ own 24 ∧ (62 ∨ own 37))`**. Safe order meanwhile: beast pea FIRST, re-take bag, then fish→cat, then bag→cat |
