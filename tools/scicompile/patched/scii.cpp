// PATCHED COPY (build-time) of scii.cpp -- vendor original is UNMODIFIED.
// scicompile: mechanical MSVC->GCC fix only (MSVC list-iterator _Mynode() -> _M_node). See BUILD_NOTES.md.
/***************************************************************************
...
{
    return _Right._M_node < _Left._M_node;
}
