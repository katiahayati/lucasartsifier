// PATCHED COPY (build-time) of Compile.cpp -- vendor original is UNMODIFIED.
...
CodeResult SendCall::OutputByteCode(CompileContext &context) const
{
...

    {
        ...
        SendTargetSpeciesIndex objectSpecies(context, (bOpSend == Opcode::SELF) ? SpeciesIndex(DataTypeAny) : wObjectSpecies, GetTargetName());
