...
| 3 | **rm660 → rm670** (Charon's crossing, coin consumed, one-way) | mirror 24, gauntlet 15 | `[U]` gauntlet is sourced at rm650, *before* the crossing, and without it the game refuses to show Death the mirror |
| 4 | **rm680 → rm155** (Realm exit — the last crossing that can still comply; rm155 is a funnel) | handkerchief 17, skeletonKey 44, **cup filled** (flag 58) | `[U]` "we should not let you leave the realm of the dead without it". Handkerchief (rm630) and key (rm640) exist only inside and are needed at rm820 |
