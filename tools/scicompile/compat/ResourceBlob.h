...
{
    // GCC two-phase lookup: bring the dependent base's bitfield members into scope.
    using _TLayout::iNumber;
    using _TLayout::iType;
    using _TLayout::iOffset;
    using _TLayout::iPackageNumber;
