// PATCHED COPY (build-time) of ResourceMap.cpp -- vendor original is UNMODIFIED.
// scicompile: mechanical MSVC->GCC fixes only (rvalue iterator& binding in resource enumeration). See BUILD_NOTES.md.
/***************************************************************************
