// PATCHED COPY (build-time) of AudioResourceSource.cpp -- vendor original is UNMODIFIED.
// scicompile: mechanical MSVC->GCC fixes only (by-value proxy iterator). See BUILD_NOTES.md.
/***************************************************************************
