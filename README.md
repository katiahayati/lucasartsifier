...
"Findings" is every detector's verdict unioned per item; "edits placed" counts the guard and sink
sites the patcher actually landed. KQ6's missing two are the suite's one deliberate red — a
shared-dispatcher seam and a trade-shaped sink, both with their reasons written down rather than
quietly dropped.
