...
extern const TCHAR *g_rgszTypeToSectionName[];
...
extern TCHAR g_szGdiplusFilter[];
...
extern EGACOLOR g_egaColorChooserPalette[];
...
extern const TCHAR* g_szResourceSpecByType[(int)ResourceType::Max];
