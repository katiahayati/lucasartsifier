// PATCHED COPY (build-time) of Vocab000.cpp -- vendor original is UNMODIFIED.
// scicompile: mechanical MSVC->GCC fix only (disambiguate tolower overload). See BUILD_NOTES.md.
/***************************************************************************
...
VocabChangeHint Vocab000::AddNewWord(PCTSTR pszWordIn, WordClass dwClass, bool fShowUI)
{
    ...
    transform(strLower.begin(), strLower.end(), strLower.begin(), (int(*)(int))::tolower);
