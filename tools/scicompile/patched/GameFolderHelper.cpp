// PATCHED COPY (build-time) of GameFolderHelper.cpp -- vendor original is UNMODIFIED.
// scicompile: mechanical MSVC->GCC fixes only (rvalue unique_ptr& / iterator& bindings). See BUILD_NOTES.md.
/***************************************************************************
