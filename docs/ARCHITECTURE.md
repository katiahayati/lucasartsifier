...
### Tests (139)
`test_gate_aware` (35) · `test_control_oracle` (32) · `test_everything` (25) · `test_guards` (17) ·
`test_abstractions` (20) · `test_anchors` (10). All on synthetic inputs — end-to-end scoring lives in
`python -m missability` and `python -m guards`.
